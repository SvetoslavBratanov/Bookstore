...
public class CheckoutController {
	...
	public String checkoutPost(@ModelAttribute("shippingAddress") ShippingAddress shippingAddress,
		...
		mailSender.send(mailConstructor.constructOrderConfirmationEmail(user, order, true, Locale.ENGLISH));
		mailSender.send(mailConstructor.constructOrderConfirmationEmail(user, order, false,  Locale.ENGLISH));
